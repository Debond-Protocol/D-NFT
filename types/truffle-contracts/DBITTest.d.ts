...
export interface DBITTestContract extends Truffle.Contract<DBITTestInstance> {
  "new"(
...
export interface DBITTestInstance extends Truffle.ContractInstance {
  _airdropBalance(
    arg0: string,
