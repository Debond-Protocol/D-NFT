...
function codegenContractInstanceInterface(c) {
    const functionsCode = lodash_1.values(c.functions)
...
function generateConstantFunction(fn, overloadedName) {
    return `
  ${generateFunctionDocumentation(fn.documentation)}
  ${overloadedName !== null && overloadedName !== void 0 ? overloadedName : fn.name}(${types_1.codegenInputTypes(fn.inputs)} txDetails?: Truffle.TransactionDetails): Promise<${types_1.codegenOutputTypes(fn.outputs)}>;
`;
}
